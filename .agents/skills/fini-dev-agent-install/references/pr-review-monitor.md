...
- whitelist config, such as `~/.fini-dev/pr-review-monitor/whitelist.json`
- queue, such as `~/.fini-dev/pr-review-monitor/queue.json`
- state, such as `~/.fini-dev/pr-review-monitor/state.json`
- lock directory, such as `~/.fini-dev/pr-review-monitor/lock`
