...
- Count path: the transition observer increments `focus_enter_count` once when the reminder quest becomes resolved Focus, and repeated reads after the due boundary do not increment it again.
